    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                ...
                <Link to="/transactions" className="text-sm text-indigo-400 hover:text-indigo-300 flex items-center gap-1">
            ...
            <div className="space-y-3">
                {recent.map((trx) => {
                    ...
                    return (
                        <div key={trx.id} className="bg-slate-900 border border-slate-800 p-4 rounded-xl flex items-center gap-4 hover:border-slate-700 transition-colors">
                            <div className={cn(
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-white font-medium capitalize truncate">{trx.note || trx.category}</p>
